...
public class Main {
    ...
    private static final int QTD_TESTS;
    ...
    public static void main(String[] args) {
        ...
        //TEST ARRAY SIZE 5
        tests[0] = new TestManager(QTD_TESTS,5);

        //TEST ARRAY SIZE 50
        tests[1] = new TestManager(QTD_TESTS, 50);

        //TEST ARRAY SIZE 100
        tests[2] = new TestManager(QTD_TESTS, 100);

        //TEST ARRAY SIZE 1000
        tests[3] = new TestManager(QTD_TESTS, 1000);

        //TEST ARRAY SIZE 10000
        tests[4] = new TestManager(QTD_TESTS, 10000);
